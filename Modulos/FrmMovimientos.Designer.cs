namespace Reportes
{
	partial class FrmMovimientos
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbAlmacenArticulos = new System.Windows.Forms.ComboBox();
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.cbAlmacen);
			...
			// tabPage2
			// 
			this.tabPage2.Controls.Add(this.cbAlmacenArticulos);
			...
			this.BtnCorrerQueryArticulos.Location = new System.Drawing.Point(400, 184);
			...
			this.cbAlmacen.Location = new System.Drawing.Point(38, 186);
			this.cbAlmacen.Name = "cbAlmacen";
			this.cbAlmacen.Size = new System.Drawing.Size(306, 28);
			this.cbAlmacen.TabIndex = 39;
			this.help.SetToolTip(this.cbAlmacen, "Tipo de movimiento");
			// 
			// cbAlmacenArticulos
			// 
			this.cbAlmacenArticulos.FormattingEnabled = true;
			this.cbAlmacenArticulos.Location = new System.Drawing.Point(362, 149);
			this.cbAlmacenArticulos.Name = "cbAlmacenArticulos";
			this.cbAlmacenArticulos.Size = new System.Drawing.Size(306, 28);
			this.cbAlmacenArticulos.TabIndex = 50;
			this.help.SetToolTip(this.cbAlmacenArticulos, "Tipo de movimiento");
			// 
			// FrmMovimientos
			// 
		...
		private System.Windows.Forms.ComboBox cbAlmacenArticulos;
	}
}